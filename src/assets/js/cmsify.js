...
},{"vue":115,"vue-hot-reload-api":111}],2:[function(require,module,exports){
"use strict";
...
},{"vue":115,"vue-hot-reload-api":111}],3:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        ...
        store: function store() {
            ...
            this.$http.post('/cmsify/api/categories', data).then(function (r) {
                _this.open = true;
                if (!_this.node.children) {
                    _this.node.children = [];
                }
                _this.node.children.push(r.data);
        ...
        update: function update() {
            ...
            this.$http.put('/cmsify/api/categories/' + this.node.id, { name: this.node.name }).then(function (r) {
                _this2.node = r.data;
                _this2.open = true;
            });
            this.mode = 'show';
        ...
        remove: function remove() {
            ...
            this.$http.delete('/cmsify/api/categories/' + this.node.id).then(function (r) {
                _this3.$dispatch('category-child-removed', { node: _this3.node });
                _this3.node.children = null;
                _this3.node = null;
            });
        }
    },
...
},{"vue":115,"vue-hot-reload-api":111,"vueify/lib/insert-css":116}],4:[function(require,module,exports){
'use strict';
...
_vue2.default.component('cmsify-category', require('./components/Category.vue'));

_vue2.default.use(_vueRouter2.default);
_vue2.default.use(_vueResource2.default);
_vue2.default.http.headers.common['X-CSRF-TOKEN'] = document.querySelector('#token').getAttribute('value');

_vue2.default.filter('moment', function (date, format) {
    return (0, _momentjs2.default)(date).format(format);
});
_vue2.default.filter('chunk', function (array, length) {
    var totalChunks = [];
...
},{"./DashboardView.vue":1,"./PagesView.vue":2,"./components/Category.vue":3,"./pages/form.vue":6,"./pages/index.vue":7,"./pages/show.vue":8,"momentjs":109,"vue":115,"vue-resource":112,"vue-router":113}],5:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        draftState: function draftState() {
...
var _ModelFormMixin = require('../mixins/ModelFormMixin');

var _ModelFormMixin2 = _interopRequireDefault(_ModelFormMixin);
...
exports.default = {
    ...
    mixins: [_ModelFormMixin2.default],
    ...
    ready: function ready() {
        ...
        if (parseInt(vm.$route.params.id)) {
            vm.$http.get('/cmsify/api/posts/' + vm.$route.params.id + '/edit').then(function (r) {
                vm.model = r.data;
                vm.tags = r.data.tags;
    ...
    methods: {
        ...
        getTags: function getTags(search, loading) {
            var _this = this;

            loading(true);
            this.$http.get('/cmsify/api/tags', { q: search }).then(function (r) {
                _this.tags = r.data;
                loading(false);
            });
        },
        getCategories: function getCategories(search, loading) {
            var _this2 = this;

            loading(true);
            this.$http.get('/cmsify/api/categories', { q: search }).then(function (r) {
                _this2.categories = r.data;
                loading(false);
            });
        }
    }
...
},{"../mixins/ModelFormMixin":5,"vue":115,"vue-hot-reload-api":111,"vue-select":114,"vueify/lib/insert-css":116}],7:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        destroy: function destroy(post) {
            ...
            this.$http.delete('/cmsify/api/posts/' + post.id).then(function (r) {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<div>\n\n    <div class=\"row\">\n        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right\">\n            <a v-link=\"{name : 'page_create', params : {categoryId : $route.params.categoryId }}\" class=\"btn btn-primary\">Create Post</a>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">\n            <div class=\"table-responsive\">\n                <table class=\"table table-hover\">\n                    <thead>\n                    <tr>\n                        <th>#</th>\n                        <th>Title</th>\n                        <th>Created</th>\n                        <th>Updated</th>\n                        <th></th>\n                    </tr>\n                    </thead>\n                    <tbody>\n                    <tr v-for=\"post in posts\">\n                        <td>{{ post.id }}\n                            <label class=\"label label-success\" v-if=\"post.state == 'published'\">published</label>\n                            <label class=\"label label-primary\" v-else=\"\">draft</label>\n                        </td>\n                        <td>\n                            {{ post.title }}\n                        </td>\n                        <td>{{ post.created_at | moment 'YYYY-DD-MM h:mm' }}</td>\n                        <td>{{ post.updated_at | moment 'YYYY-DD-MM h:mm' }}</td>\n                        <td class=\"text-right\">\n\n                            <a class=\"btn btn-default\" v-link=\"{name : 'page_show', params : {categoryId : $route.params.categoryId, id: post.id }}\"><i class=\"fa fa-list\"></i></a>\n\n                            <!--Edit button-->\n                            <a v-if=\"post.canEdit\" v-link=\"{name : 'page_edit', params : {categoryId : $route.params.categoryId, id: post.id }}\" class=\"btn btn-primary\"><i class=\"fa fa-edit\"></i></a>\n                            <button v-else=\"\" style=\"opacity: 0.5\" class=\"btn btn-primary\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"only Creator has Permission\"><i class=\"fa fa-edit\"></i></button>\n\n                            <!--Remove Button-->\n                            <button v-if=\"post.canDelete\" @click=\"destroy(post)\" class=\"btn btn-danger\"><i class=\"fa fa-remove\"></i></button>\n                            <button v-else=\"\" style=\"opacity: 0.5\" class=\"btn btn-danger\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"only Creator has Permission\"><i class=\"fa fa-remove\"></i>\n                            </button>\n\n                        </td>\n                    </tr>\n                    </tbody>\n                </table>\n            </div>\n        </div>\n    </div>\n\n</div>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"vue":115,"vue-hot-reload-api":111}],8:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n.Relations__Item {\n    margin-right:3px;\n}\n\n")
'use strict';
...
exports.default = {
    ...
    ready: function ready() {
        ...
        if (parseInt(vm.$route.params.id)) {
            vm.$http.get('/cmsify/api/posts/' + vm.$route.params.id).then(function (r) {
                vm.model = r.data;
            });
        } else {}
    },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-267e0bbc", module.exports)
  } else {
    hotAPI.update("_v-267e0bbc", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../mixins/ModelFormMixin":5,"vue":115,"vue-hot-reload-api":111,"vue-select":114,"vueify/lib/insert-css":116}],9:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/json/stringify"), __esModule: true };
},{"core-js/library/fn/json/stringify":23}],10:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/create"), __esModule: true };
},{"core-js/library/fn/object/create":24}],11:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-properties"), __esModule: true };
},{"core-js/library/fn/object/define-properties":25}],12:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/define-property"), __esModule: true };
},{"core-js/library/fn/object/define-property":26}],13:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/get-own-property-descriptor"), __esModule: true };
},{"core-js/library/fn/object/get-own-property-descriptor":27}],14:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/get-own-property-names"), __esModule: true };
},{"core-js/library/fn/object/get-own-property-names":28}],15:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/get-own-property-symbols"), __esModule: true };
},{"core-js/library/fn/object/get-own-property-symbols":29}],16:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/get-prototype-of"), __esModule: true };
},{"core-js/library/fn/object/get-prototype-of":30}],17:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/is-extensible"), __esModule: true };
},{"core-js/library/fn/object/is-extensible":31}],18:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/keys"), __esModule: true };
},{"core-js/library/fn/object/keys":32}],19:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/prevent-extensions"), __esModule: true };
},{"core-js/library/fn/object/prevent-extensions":33}],20:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/symbol"), __esModule: true };
},{"core-js/library/fn/symbol":34}],21:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/symbol/iterator"), __esModule: true };
},{"core-js/library/fn/symbol/iterator":35}],22:[function(require,module,exports){
"use strict";
...
},{"../core-js/symbol":20,"../core-js/symbol/iterator":21}],23:[function(require,module,exports){
var core  = require('../../modules/_core')
  , $JSON = core.JSON || (core.JSON = {stringify: JSON.stringify});
module.exports = function stringify(it){ // eslint-disable-line no-unused-vars
  return $JSON.stringify.apply($JSON, arguments);
};
},{"../../modules/_core":41}],24:[function(require,module,exports){
require('../../modules/es6.object.create');
var $Object = require('../../modules/_core').Object;
module.exports = function create(P, D){
  return $Object.create(P, D);
};
},{"../../modules/_core":41,"../../modules/es6.object.create":94}],25:[function(require,module,exports){
require('../../modules/es6.object.define-properties');
var $Object = require('../../modules/_core').Object;
module.exports = function defineProperties(T, D){
  return $Object.defineProperties(T, D);
};
},{"../../modules/_core":41,"../../modules/es6.object.define-properties":95}],26:[function(require,module,exports){
require('../../modules/es6.object.define-property');
var $Object = require('../../modules/_core').Object;
module.exports = function defineProperty(it, key, desc){
  return $Object.defineProperty(it, key, desc);
};
},{"../../modules/_core":41,"../../modules/es6.object.define-property":96}],27:[function(require,module,exports){
require('../../modules/es6.object.get-own-property-descriptor');
var $Object = require('../../modules/_core').Object;
module.exports = function getOwnPropertyDescriptor(it, key){
  return $Object.getOwnPropertyDescriptor(it, key);
};
},{"../../modules/_core":41,"../../modules/es6.object.get-own-property-descriptor":97}],28:[function(require,module,exports){
require('../../modules/es6.object.get-own-property-names');
var $Object = require('../../modules/_core').Object;
module.exports = function getOwnPropertyNames(it){
  return $Object.getOwnPropertyNames(it);
};
},{"../../modules/_core":41,"../../modules/es6.object.get-own-property-names":98}],29:[function(require,module,exports){
require('../../modules/es6.symbol');
module.exports = require('../../modules/_core').Object.getOwnPropertySymbols;
},{"../../modules/_core":41,"../../modules/es6.symbol":105}],30:[function(require,module,exports){
require('../../modules/es6.object.get-prototype-of');
module.exports = require('../../modules/_core').Object.getPrototypeOf;
},{"../../modules/_core":41,"../../modules/es6.object.get-prototype-of":99}],31:[function(require,module,exports){
require('../../modules/es6.object.is-extensible');
module.exports = require('../../modules/_core').Object.isExtensible;
},{"../../modules/_core":41,"../../modules/es6.object.is-extensible":100}],32:[function(require,module,exports){
...
},{"../../modules/_core":41,"../../modules/es6.object.prevent-extensions":102}],34:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
require('../../modules/es7.symbol.async-iterator');
require('../../modules/es7.symbol.observable');
module.exports = require('../../modules/_core').Symbol;
},{"../../modules/_core":41,"../../modules/es6.object.to-string":103,"../../modules/es6.symbol":105,"../../modules/es7.symbol.async-iterator":106,"../../modules/es7.symbol.observable":107}],35:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/web.dom.iterable');
module.exports = require('../../modules/_wks-ext').f('iterator');
},{"../../modules/_wks-ext":91,"../../modules/es6.string.iterator":104,"../../modules/web.dom.iterable":108}],36:[function(require,module,exports){
...
},{"./_is-object":57}],39:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./_to-index":83,"./_to-iobject":85,"./_to-length":86}],40:[function(require,module,exports){
...
},{"./_a-function":36}],43:[function(require,module,exports){
...
},{"./_global":50,"./_is-object":57}],46:[function(require,module,exports){
...
},{"./_object-gops":71,"./_object-keys":74,"./_object-pie":75}],48:[function(require,module,exports){
...
},{"./_core":41,"./_ctx":42,"./_global":50,"./_hide":52}],49:[function(require,module,exports){
...
},{"./_descriptors":44,"./_object-dp":66,"./_property-desc":77}],53:[function(require,module,exports){
module.exports = require('./_global').document && document.documentElement;
},{"./_global":50}],54:[function(require,module,exports){
module.exports = !require('./_descriptors') && !require('./_fails')(function(){
  return Object.defineProperty(require('./_dom-create')('div'), 'a', {get: function(){ return 7; }}).a != 7;
});
},{"./_descriptors":44,"./_dom-create":45,"./_fails":49}],55:[function(require,module,exports){
// fallback for non-array-like ES3 and non-enumerable old V8 strings
var cof = require('./_cof');
module.exports = Object('z').propertyIsEnumerable(0) ? Object : function(it){
  return cof(it) == 'String' ? it.split('') : Object(it);
};
},{"./_cof":40}],56:[function(require,module,exports){
...
},{"./_hide":52,"./_object-create":65,"./_property-desc":77,"./_set-to-string-tag":79,"./_wks":92}],59:[function(require,module,exports){
'use strict';
...
},{"./_export":48,"./_has":51,"./_hide":52,"./_iter-create":58,"./_iterators":61,"./_library":63,"./_object-gpo":72,"./_redefine":78,"./_set-to-string-tag":79,"./_wks":92}],60:[function(require,module,exports){
...
},{"./_object-keys":74,"./_to-iobject":85}],63:[function(require,module,exports){
module.exports = true;
...
},{"./_fails":49,"./_has":51,"./_is-object":57,"./_object-dp":66,"./_uid":89}],65:[function(require,module,exports){
...
},{"./_an-object":38,"./_dom-create":45,"./_enum-bug-keys":46,"./_html":53,"./_object-dps":67,"./_shared-key":80}],66:[function(require,module,exports){
var anObject       = require('./_an-object')
...
},{"./_an-object":38,"./_descriptors":44,"./_ie8-dom-define":54,"./_to-primitive":88}],67:[function(require,module,exports){
var dP       = require('./_object-dp')
...
},{"./_an-object":38,"./_descriptors":44,"./_object-dp":66,"./_object-keys":74}],68:[function(require,module,exports){
...
},{"./_descriptors":44,"./_has":51,"./_ie8-dom-define":54,"./_object-pie":75,"./_property-desc":77,"./_to-iobject":85,"./_to-primitive":88}],69:[function(require,module,exports){
...
},{"./_object-gopn":70,"./_to-iobject":85}],70:[function(require,module,exports){
...
},{"./_enum-bug-keys":46,"./_object-keys-internal":73}],71:[function(require,module,exports){
...
},{"./_has":51,"./_shared-key":80,"./_to-object":87}],73:[function(require,module,exports){
var has          = require('./_has')
  , toIObject    = require('./_to-iobject')
...
},{"./_array-includes":39,"./_has":51,"./_shared-key":80,"./_to-iobject":85}],74:[function(require,module,exports){
...
},{"./_enum-bug-keys":46,"./_object-keys-internal":73}],75:[function(require,module,exports){
...
},{"./_core":41,"./_export":48,"./_fails":49}],77:[function(require,module,exports){
...
},{"./_has":51,"./_object-dp":66,"./_wks":92}],80:[function(require,module,exports){
...
},{"./_global":50}],82:[function(require,module,exports){
...
},{"./_defined":43,"./_to-integer":84}],83:[function(require,module,exports){
var toInteger = require('./_to-integer')
  , max       = Math.max
  , min       = Math.min;
...
},{"./_defined":43,"./_iobject":55}],86:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer')
  , min       = Math.min;
module.exports = function(it){
...
},{"./_defined":43}],88:[function(require,module,exports){
...
},{"./_core":41,"./_global":50,"./_library":63,"./_object-dp":66,"./_wks-ext":91}],91:[function(require,module,exports){
...
$exports.store = store;
},{"./_global":50,"./_shared":81,"./_uid":89}],93:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":37,"./_iter-define":59,"./_iter-step":60,"./_iterators":61,"./_to-iobject":85}],94:[function(require,module,exports){
var $export = require('./_export')
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
$export($export.S, 'Object', {create: require('./_object-create')});
},{"./_export":48,"./_object-create":65}],95:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.3 / 15.2.3.7 Object.defineProperties(O, Properties)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', {defineProperties: require('./_object-dps')});
},{"./_descriptors":44,"./_export":48,"./_object-dps":67}],96:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', {defineProperty: require('./_object-dp').f});
},{"./_descriptors":44,"./_export":48,"./_object-dp":66}],97:[function(require,module,exports){
...
},{"./_object-gopd":68,"./_object-sap":76,"./_to-iobject":85}],98:[function(require,module,exports){
// 19.1.2.7 Object.getOwnPropertyNames(O)
require('./_object-sap')('getOwnPropertyNames', function(){
  return require('./_object-gopn-ext').f;
});
},{"./_object-gopn-ext":69,"./_object-sap":76}],99:[function(require,module,exports){
...
},{"./_object-gpo":72,"./_object-sap":76,"./_to-object":87}],100:[function(require,module,exports){
...
},{"./_is-object":57,"./_object-sap":76}],101:[function(require,module,exports){
...
},{"./_object-keys":74,"./_object-sap":76,"./_to-object":87}],102:[function(require,module,exports){
...
},{"./_is-object":57,"./_meta":64,"./_object-sap":76}],103:[function(require,module,exports){
...
},{"./_iter-define":59,"./_string-at":82}],105:[function(require,module,exports){
'use strict';
...
},{"./_an-object":38,"./_descriptors":44,"./_enum-keys":47,"./_export":48,"./_fails":49,"./_global":50,"./_has":51,"./_hide":52,"./_is-array":56,"./_keyof":62,"./_library":63,"./_meta":64,"./_object-create":65,"./_object-dp":66,"./_object-gopd":68,"./_object-gopn":70,"./_object-gopn-ext":69,"./_object-gops":71,"./_object-keys":74,"./_object-pie":75,"./_property-desc":77,"./_redefine":78,"./_set-to-string-tag":79,"./_shared":81,"./_to-iobject":85,"./_to-primitive":88,"./_uid":89,"./_wks":92,"./_wks-define":90,"./_wks-ext":91}],106:[function(require,module,exports){
require('./_wks-define')('asyncIterator');
},{"./_wks-define":90}],107:[function(require,module,exports){
require('./_wks-define')('observable');
},{"./_wks-define":90}],108:[function(require,module,exports){
...
},{"./_global":50,"./_hide":52,"./_iterators":61,"./_wks":92,"./es6.array.iterator":93}],109:[function(require,module,exports){
'use strict';
...
},{"babel-runtime/core-js/json/stringify":9,"babel-runtime/core-js/object/create":10,"babel-runtime/core-js/object/define-properties":11,"babel-runtime/core-js/object/define-property":12,"babel-runtime/core-js/object/get-own-property-descriptor":13,"babel-runtime/core-js/object/get-own-property-names":14,"babel-runtime/core-js/object/get-own-property-symbols":15,"babel-runtime/core-js/object/get-prototype-of":16,"babel-runtime/core-js/object/is-extensible":17,"babel-runtime/core-js/object/keys":18,"babel-runtime/core-js/object/prevent-extensions":19,"babel-runtime/helpers/typeof":22}],115:[function(require,module,exports){
...
},{"_process":110}],116:[function(require,module,exports){
...
//# sourceMappingURL=cmsify.js.map
